...
<section >
 ...
 <div class="col-lg-8"  id="divz">
   <div class="panel panel-primary">
     <div class="panel-heading"> <h1 class="text-center ">My Appointments</h1></div>
      ...
      <tbody>
       ...
       if (isset($_GET['appointment_id'])) {
        ...
        //section that displays the specific message of the patient
          ...
          $fetch_appointments = "SELECT * FROM appointments WHERE appointment_id = '$_GET[appointment_id]'";
          $sql_query = mysqli_query($connected ,  $fetch_appointments);
          $serial_no_listing = 1;
           while ($rows = mysqli_fetch_array($sql_query)) {
            # code...
            ...
            echo ' 
              ...
              <td>'.($status == 'Approve'? '<a href="view_request.php?new_status=Approved&id" class="btn btn-default btn-xs"><span class=""><img src="../img/cancel.png" width="18px"> Unapproved</span></a>' : '<a href="view_request.php?new_status=Approve&id=" class="btn btn-primary btn-xs"><span class=""><img src="../img/maps-and-flags.png" width="18px">&nbsp; Approved</span></a>').'
                </td>
                 <td>'.  $reply.'</td>
               <td><a href="appointments.php?del_id" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a></td>
