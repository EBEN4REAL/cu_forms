...
<section >
 ...
 <div class="col-lg-8"  id="divz">
   <div class="panel panel-primary">
     <div class="panel-heading"> <h1 class="text-center ">Received Broadcasts</h1></div>
      ...
      <tbody>
       <?php
        ...
        if (isset($_GET['alert_id'])) {
          ...
          $fetch_emergencies = "SELECT * FROM alerts WHERE id = '$_GET[alert_id]';
          ";
           ...
           while ($rows = mysqli_fetch_array($sql_query)) {
            ...
            echo ' 
              <tr>
               ...
               <td>'. $alert.'...</td>
               <td><img src="../img/capturec.PNG" width="20px"> '.$sender.'</td>
               <td>'.$date.'</td>
