...
<section >
 ...
 <div class="col-lg-8"  id="divz">
   <div class="panel panel-primary" class="table-responsive">
     <div class="panel-heading"> <h1 class="text-center ">My Requests</h1></div>
           ...
           while ($rows = mysqli_fetch_array($sql_query)) {
            ...
            echo ' 
              <tr>
               ...
               <td>'.($status == 'Approve'? '<a href="#" class="btn btn-default btn-xs"><span class=""><img src="../img/cancel.png" width="18px"> Unapproved</span></a>' : '<a href="#" class="btn btn-success btn-xs"><span class=""><img src="../img/maps-and-flags.png" width="18px">&nbsp; Approved</span></a>').'
                </td>
               <td><a href="open_requests.php?request_id='.$rows['id'].'" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;View</a></td>
               
               
               <td><a href="requests.php?del_id='.$rows['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a></td>
