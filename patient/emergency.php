...
//section that selects each user
 ...
 <div class="col-lg-8"  id="divz">
   <div class="panel panel-primary">
     <div class="panel-heading">
       <h4>Reported Emergency cases</h4>
     </div>
     <div class="body">
      ...
      <tbody>
       ...
       if (isset($_GET['del_id'])) {
        ...
        $sql_query = mysqli_query($connected , $delete_from_db);
          ...
          $fetch_emergencies = "SELECT * FROM emergency_report WHERE user_id = $_SESSION[user_id]";
          ...
          $serial_no_listing = 1;
           while ($rows = mysqli_fetch_array($sql_query)) {
            ...
            $author =  $full_name;
            $report =substr($rows['report'], 0,25);
            ...
            echo ' 
              <tr>
               <td>'.$serial_no_listing.'</td>
                <td>'.$report.'</td>
                <td><img src="../img/capturec.PNG" width="20px"> '.$author.'</td>
                <td>'.$date.'</td>
                 <td><a href="view_emergency.php?emergency_id='.$rows['id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-eye-open"></span> View</td>
                <td><a href="emergency.php?del_id='.$rows['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Delete</td>
              </tr>
