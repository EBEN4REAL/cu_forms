...
foreach ($_POST['checkBoxArray'] as $checkBoxValue ) {
    # code...
     ...
     $query = "UPDATE user SET alert = '$alert' WHERE id = '$checkBoxValue'";
     $sql_query = mysqli_query($connected , $query);

    $banner = '<div class="alert alert-success" style="border-radius:0">Reply sent Successfully!</div>';
