            ...
            echo ' 
              <tr>
               <td>'.$serial_no_listing.'</td>
                ...
                <td><a href="reply_appointment.php?appointment_id='.$rows['appointment_id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-check"></span>&nbsp; Reply</a></td>
...
<!--   $fetch_appoitments = "SELECT * FROM appointments INNER JOIN user ON user.id = appointments.user_id  WHERE user.id  =  '$_GET[appointment_id]'"; -->